...
CREATE OR REPLACE VARIABLE SAILW0317V.ASTINEQ_V7_COHORT_SELECTION_JAN2021_STUDY_ENDDATE DATE DEFAULT '2012-12-31';  -- NULL

CREATE OR REPLACE VARIABLE SAILW0317V.ASTINEQ_V7_COHORT_SELECTION_JAN2021_EVER DATE DEFAULT '1930-01-01';  -- NULL

CREATE OR REPLACE VARIABLE SAILW0317V.ASTINEQ_V7_COHORT_SELECTION_JAN2021_FOLLOWUP_START_DATE DATE DEFAULT '2013-01-01';  -- NULL


 call fnc.drop_if_exists('SAILW0317V.ASTINEQ_V7_COHORT_SELECTION_JAN2021');

CREATE TABLE SAILW0317V.ASTINEQ_V7_COHORT_SELECTION_JAN2021 (
	...
	ASTHMA_RX_12M_5 SMALLINT DEFAULT 0
	   ...
	   INSERT INTO    SAILW0317V.ASTINEQ_V7_COHORT_SELECTION_JAN2021(ALF_PE)
	...
	MERGE INTO    SAILW0317V.ASTINEQ_V7_COHORT_SELECTION_JAN2021 a
	...
	FROM              (SELECT P.ALF_PE, MAX(P.GNDR_CD) AS GNDR_CD, MAX(P.WOB) AS WOB, MAX(P.DOD) AS DOD FROM SAIL0317V.WDSD_AR_PERS_20181101 P JOIN SAILW0317V.ASTINEQ_V7_COHORT_SELECTION_JAN2021 A ON P.ALF_PE = A.ALF_PE GROUP BY P.ALF_PE)
	...
	WHEN MATCHED THEN UPDATE SET a.GNDR_CD = b.GNDR_CD, a.WOB = b.WOB, a.DOD = b.DOD;
		 ...
		 FROM		SAILW0317V.ASTINEQ_V7_COHORT_SELECTION_JAN2021  A1
		 	   	   ...
		 	   	   AND		(
						...
						AND 		(G.EVENT_DT >= SAILW0317V.ASTINEQ_V7_COHORT_SELECTION_JAN2021_EVER AND G.EVENT_DT < SAILW0317V.ASTINEQ_V7_COHORT_SELECTION_JAN2021_STUDY_ENDDATE)
		 ...
		 FROM		SAILW0317V.ASTINEQ_V7_COHORT_SELECTION_JAN2021
		 ...
		 FROM		SAILW0317V.ASTINEQ_V7_COHORT_SELECTION_JAN2021  A1
		 	   	   ...
		 	   	   AND		(
						...
						AND 		(G.EVENT_DT >= SAILW0317V.ASTINEQ_V7_COHORT_SELECTION_JAN2021_FOLLOWUP_START_DATE AND G.EVENT_DT < SAILW0317V.ASTINEQ_V7_COHORT_SELECTION_JAN2021_FOLLOWUP_START_DATE + 1 YEAR - 1 DAY)
		 ...
		 -- Asthma prescriptions in the last 12 months - year 2
		 ...
		 FROM		SAILW0317V.ASTINEQ_V7_COHORT_SELECTION_JAN2021  A1
		 	   	   ...
		 	   	   AND		(
						...
						AND 		(G.EVENT_DT >= SAILW0317V.ASTINEQ_V7_COHORT_SELECTION_JAN2021_FOLLOWUP_START_DATE + 1 YEAR AND G.EVENT_DT < SAILW0317V.ASTINEQ_V7_COHORT_SELECTION_JAN2021_FOLLOWUP_START_DATE + 2 YEAR - 1 DAY)
		 ...
		 -- Asthma prescriptions in the last 12 months - year 3
		 ...
		 FROM		SAILW0317V.ASTINEQ_V7_COHORT_SELECTION_JAN2021  A1
		 	   	   ...
		 	   	   AND		(
						...
						AND 		(G.EVENT_DT >= SAILW0317V.ASTINEQ_V7_COHORT_SELECTION_JAN2021_FOLLOWUP_START_DATE + 2 YEAR AND G.EVENT_DT < SAILW0317V.ASTINEQ_V7_COHORT_SELECTION_JAN2021_FOLLOWUP_START_DATE + 3 YEAR - 1 DAY)
		 ...
		 -- Asthma prescriptions in the last 12 months - year 4
		 ...
		 FROM		SAILW0317V.ASTINEQ_V7_COHORT_SELECTION_JAN2021  A1
		 	   	   ...
		 	   	   AND		(
						...
						AND 		(G.EVENT_DT >= SAILW0317V.ASTINEQ_V7_COHORT_SELECTION_JAN2021_FOLLOWUP_START_DATE + 3 YEAR AND G.EVENT_DT < SAILW0317V.ASTINEQ_V7_COHORT_SELECTION_JAN2021_FOLLOWUP_START_DATE + 4 YEAR - 1 DAY)
		 ...
		 -- Asthma prescriptions in the last 12 months - year 5
		 ...
		 FROM		SAILW0317V.ASTINEQ_V7_COHORT_SELECTION_JAN2021  A1
		 	   	   ...
		 	   	   AND		(
						...
						AND 		(G.EVENT_DT >= SAILW0317V.ASTINEQ_V7_COHORT_SELECTION_JAN2021_FOLLOWUP_START_DATE + 4 YEAR AND G.EVENT_DT < SAILW0317V.ASTINEQ_V7_COHORT_SELECTION_JAN2021_FOLLOWUP_START_DATE + 5 YEAR - 1 DAY)
